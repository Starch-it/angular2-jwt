...
### **NOTE:** This library is a fork of [@auth0/angular-jwt](https://github.com/auth0/angular2-jwt) and is published on npm as `@marcozi/angular-jwt`.

This fork implements two changes:

- the whitelist and the blacklist are checked before calling handleInterception
- tokenGetter can return differentValues based on the request
